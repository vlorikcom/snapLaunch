            ...
            {/* <div className="mt-6">
              ...
              <form className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg bg-zinc-800/50 px-3 py-2 text-sm text-white placeholder-zinc-500 outline-hidden ring-zinc-700 transition-shadow focus:ring-2"
                />
                <button
                  type="submit"
